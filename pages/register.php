...
<body>
    <form method="post" class="login-form">
        ...
        <div class="box">
            <input type="text" name="login" required> <span data-placeholder="Логин"></span> </div>
        <div class="box">
            <input type="password" name="password" required> <span data-placeholder="Пароль"></span> </div>
        <div class="box">
            <input type="password" name="rpassword" required> <span data-placeholder="Подтвердите пароль"></span> </div>
